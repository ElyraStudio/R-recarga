...
const BrandsSection = () => {
  const brands = [
    { name: "Epson", specialties: ["EcoTank", "Jato de Tinta", "Laser"] },
    { name: "HP", specialties: ["LaserJet", "DeskJet", "OfficeJet"] },
    { name: "Canon", specialties: ["PIXMA", "MegaTank", "imageCLASS"] },
    { name: "Lexmark", specialties: ["Laser", "Multifuncional", "Corporativo"] },
    { name: "EcoTank", specialties: ["Tanque de tinta", "Alta rendimento", "Econômico"] },
  ];
      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Somos especialistas nas principais marcas de impressoras do mercado, garantindo diagnóstico preciso e peças originais ou compatíveis de qualidade.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 mx-auto rounded-2xl bg-muted flex items-center justify-center mb-4 group-hover:bg-primary/10 transition-colors">
                  <Printer className="w-8 h-8 text-muted-foreground group-hover:text-primary transition-colors" />
                </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground">
            Não encontrou sua marca? <span className="text-primary font-semibold">Entre em contato</span> — trabalhamos com diversas outras marcas!
          </p>
        </div>
      </div>
    </section>
